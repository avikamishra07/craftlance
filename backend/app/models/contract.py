...
from sqlalchemy import Integer, DateTime, Enum as SAEnum, ForeignKey
...
class Contract(Base):
    ...
    platform_commission: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    )

    freelancer_amount: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    )
